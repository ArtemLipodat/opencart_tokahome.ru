...
class ControllerLightcheckoutPaymentAddress extends Controller {
	public function index() {
		...
		$language_get = array('entry_firstname','entry_lastname','entry_email','entry_telephone','entry_company','entry_address_1','entry_address_2','entry_city','entry_postcode','entry_country','entry_zone','text_none');
